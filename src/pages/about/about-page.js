            ...
            <Box sx={{
                ...
                <Container>
                    ...
                    <Typography gutterBottom={true} variant="body2" sx={{color: 'text.secondary'}}>
                        The Ministry of Foreign Affairs was established in 1957 with Dr. Kwame Nkrumah, then leader of
                    ...
                    <Typography gutterBottom={true} variant="body2" sx={{color: 'text.secondary'}}>
                        ...
                        policy pronouncement. The concept of free, proud, confident Africa was to dominate the foreign
                        policy of Ghana. The independent state of Ghana had at its disposal, competent diplomats who had
                    ...
                    <Typography gutterBottom={true} variant="body2" sx={{color: 'text.secondary'}}>
                        Dr. Nkrumah established an autonomous African Affairs Secretariat under his personal direction
                        primarily to promote and effect his vision of African Unity – a foreign policy issue which
                        normally should have fallen within the purview of the Foreign Ministry. After his overthrow in
                    ...
                    <Typography gutterBottom={true} variant="body2" sx={{color: 'text.secondary'}}>
                        ...
                        diplomatic missions, honorary consulates are established to complement the work of the former in
                        the promotion of investment, trade and tourism as well as the discharge of consular functions in
                        areas with significant Ghanaian communities.
                    </Typography>
                    <Typography variant="body2" sx={{color: 'text.secondary'}}>
                        The name of the Ministry has undergone various changes in Ghana’s recent history. Its current
                        name, Ministry of Foreign Affairs and Regional Integration, was designated in 2009 to emphasise
            ...
            <Box sx={{
                ...
                <Container>
                    ...
                    <Typography gutterBottom={true} variant="body2" sx={{color: 'text.secondary'}}>
                        ...
                        responsible administratively and executively for the initiation, formulation, co-ordination and
                        management of Ghana’s Foreign Policy.
                    </Typography>
                    <Typography gutterBottom={true} variant="body2" sx={{color: 'text.secondary'}}>
                        It comprises the Headquarters, fifty (50) Diplomatic and Five (5) Consulate Generals/Consular
                        Missions as well as three (3) Subvented Organizations, viz, The Legon Centre for International
                ...
                <Container>
                    <Grid container={true} spacing={4}>
                        ...
                        <Grid item={true} xs={12} md={8}>
                            ...
                            <Typography gutterBottom={true} variant="body2" sx={{color: 'text.secondary'}}>
                                The Ministry operates at the Headquarters through the Offices of the Hon. Minister and
                                Hon. Deputy Minister as well as the Directorate and Staff of the various Bureaux. At the
                                apex of the Ministry is the Office of the Minister for Foreign Affairs and Regional
                                Integration and her Deputies, with their respective secretariats. Next, is the Office of
                                the Chief Director, to whom the following line Bureaux headed by Directors report and
                                whose competences are defined by their geographical, institutional or functional areas
                                of coverage:
                            </Typography>
                    ...
                    <Grid container={true} spacing={4}>
                        ...
                        <Grid item={true} xs={12} md={8}>
                            ...
                            <Typography gutterBottom={true} variant="body2" sx={{color: 'text.secondary'}}>
                                ...
                                fifty-nine (59) Honorary Consulates have also been established. Several of the Missions
